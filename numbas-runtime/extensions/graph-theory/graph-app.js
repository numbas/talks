...
var $author$project$GraphApp$parse_mode = function (s) {
	var words = A2($elm$core$String$split, ' ', s);
	if (words.b && words.b.b) {
		...
		return A3($elm$core$Result$map2, $elm$core$Tuple$pair, mode, playmode);
	} else {
		return $elm$core$Result$Err('This is an invalid mode name: ' + s);
	}
};
...
var $author$project$GraphApp$set_mode = F2(
...
var $author$project$GraphApp$init = function (_v0) {
	...
	return _Utils_Tuple2(
		A2(
			$author$project$GraphApp$set_mode,
			modename,
			_Utils_update(
...
var $author$project$GraphApp$receiveScene = _Platform_incomingPort('receiveScene', $elm$json$Json$Decode$value);
var $author$project$GraphApp$settingsPort = _Platform_incomingPort('settingsPort', $elm$json$Json$Decode$value);
var $author$project$GraphApp$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$GraphApp$receiveScene($author$project$GraphApp$ReceiveScene),
...
var $author$project$GraphApp$decode_edge = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A4(
			...
			function (from) {
				return function (to) {
					return function (shape) {
						return _Utils_Tuple3(from, to, shape);
					};
				};
			},
			...
			A2(
				...
				A2($elm$json$Json$Decode$field, 'shape', $elm$json$Json$Decode$string))),
			A3(
...
var $author$project$GraphApp$d_nullable_field = F2(
	function (field, decoder) {
		return A2(
			$author$project$GraphApp$decode_default,
			$elm$core$Maybe$Nothing,
			A2(
...
var $author$project$GraphApp$decode_vector = A3(
	$elm$json$Json$Decode$map2,
	$elm$core$Tuple$pair,
...
var $author$project$GraphApp$decode_point = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A4(
			$elm$json$Json$Decode$map3,
			$author$project$GraphApp$Point,
			A2($elm$json$Json$Decode$field, 'position', $author$project$GraphApp$decode_vector),
			A2($author$project$GraphApp$d_nullable_field, 'colour', $elm$json$Json$Decode$int),
			A2($author$project$GraphApp$d_nullable_field, 'label', $elm$json$Json$Decode$string)),
			A2($elm$json$Json$Decode$map, $author$project$GraphApp$plain_point, $author$project$GraphApp$decode_vector)
		]));
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$GraphApp$tidy_scene = $elm$core$Basics$identity;
var $author$project$GraphApp$decode_scene = A2(
	$elm$json$Json$Decode$map,
	$author$project$GraphApp$tidy_scene,
	A6(
		$elm$json$Json$Decode$map5,
		$author$project$GraphApp$Scene,
		A2(
			$elm$json$Json$Decode$field,
			'points',
			$elm$json$Json$Decode$list($author$project$GraphApp$decode_point)),
		A2(
			$author$project$GraphApp$decode_default,
			_List_Nil,
			A2(
				$elm$json$Json$Decode$field,
				'edges',
				$elm$json$Json$Decode$list($author$project$GraphApp$decode_edge))),
		A2(
			$author$project$GraphApp$decode_default,
			'',
		...
		A2(
			$author$project$GraphApp$decode_default,
			_List_Nil,
			A2($elm$json$Json$Decode$field, 'path', $author$project$GraphApp$decode_path)),
		A2(
			$author$project$GraphApp$decode_default,
			1,
...
var $author$project$GraphApp$decode_can_change_mode_setting = A2(
	$elm$json$Json$Decode$field,
	'can_change_mode',
	A2(
		$elm$json$Json$Decode$map,
		function (can_change_mode) {
...
var $author$project$GraphApp$decode_disabled_setting = A2(
	$elm$json$Json$Decode$field,
	'disabled',
	A2(
		$elm$json$Json$Decode$map,
		...
		$elm$json$Json$Decode$bool));
var $author$project$GraphApp$decode_mode_setting = A2(
	$elm$json$Json$Decode$field,
	'mode',
	A2($elm$json$Json$Decode$map, $author$project$GraphApp$set_mode, $elm$json$Json$Decode$string));
var $author$project$GraphApp$decode_settings = function () {
	var optional_decoder = function (d) {
		return $elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					d,
	...
	return A3(
		...
		A2(
			...
			optional_decoder,
			_List_fromArray(
				[$author$project$GraphApp$decode_mode_setting, $author$project$GraphApp$decode_can_change_mode_setting, $author$project$GraphApp$decode_disabled_setting])));
}();
var $author$project$GraphApp$mapAt = F3(
	function (key, fn, list) {
		var indexed = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, list);
		return A3(
			$elm$core$List$foldr,
			function (_v0) {
				var i = _v0.a;
...
var $author$project$GraphApp$remove_index = F2(
	function (n, list) {
		return _Utils_ap(
...
var $author$project$GraphApp$is_adjacent = F3(
	function (i, j, model) {
		return A2(
			$elm$core$List$any,
			function (_v0) {
...
var $author$project$GraphApp$path_edges = function (path) {
	var step = F2(
		function (b, _v1) {
			var last = _v1.a;
			var edges = _v1.b;
...
var $author$project$GraphApp$path_has_edge = F2(
	function (_v0, path) {
		var a = _v0.a;
		var b = _v0.b;
		return A2(
			...
			_Utils_Tuple2(a, b),
			$author$project$GraphApp$path_edges(path)) || A2(
			$elm$core$List$member,
			_Utils_Tuple2(b, a),
			$author$project$GraphApp$path_edges(path));
	});
...
var $author$project$GraphApp$listGet = function (n) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$GraphApp$get_edge = F2(
	function (model, _v0) {
		var i = _v0.a;
		var j = _v0.b;
...
var $author$project$GraphApp$minimumMap = F2(
	function (key, list) {
		var indexed = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, list);
		var compare = F2(
			function (_v2, mb) {
				...
				if (mb.$ === 1) {
					...
					return $elm$core$Maybe$Just(
						(_Utils_cmp(
							key(a),
							key(b)) < 0) ? _Utils_Tuple2(i, a) : _Utils_Tuple2(j, b));
				}
			});
		return A3($elm$core$List$foldl, compare, $elm$core$Maybe$Nothing, indexed);
	});
...
var $author$project$GraphApp$length = function (_v0) {
	var _v1 = _v0.a;
	var x1 = _v1.a;
	var y1 = _v1.b;
	var _v2 = _v0.b;
...
var $author$project$GraphApp$dist = F2(
	function (a, b) {
		return $author$project$GraphApp$length(
			_Utils_Tuple2(a, b));
	});
var $author$project$GraphApp$point_line_distance = F2(
	function (_v0, _v1) {
		var px = _v0.a;
		var py = _v0.b;
		var _v2 = _v1.a;
		...
		var d1 = A2(
			...
			_Utils_Tuple2(x1, y1),
			_Utils_Tuple2(px, py));
		var _v4 = _Utils_Tuple2(px - x1, py - y1);
		var x = _v4.a;
		var y = _v4.b;
		var dp = $elm$core$Basics$sqrt((x * x) + (y * y));
		var _v5 = _Utils_Tuple2(x2 - x1, y2 - y1);
		var dx = _v5.a;
		var dy = _v5.b;
		var d = $elm$core$Basics$abs(((((-dy) * px) + (dx * py)) + (x1 * y2)) - (x2 * y1)) / $elm$core$Basics$sqrt((dx * dx) + (dy * dy));
		var dl = $elm$core$Basics$sqrt((dx * dx) + (dy * dy));
		var dot = (((px - x1) * dx) + ((py - y1) * dy)) / dl;
		return (dot < 0) ? d1 : ((_Utils_cmp(dot, dl) > 0) ? d2 : d);
	});
var $author$project$GraphApp$selected_edge = F3(
	function (r, model, pos) {
		var distances = A2(
			$elm$core$List$map,
			A2(
				$elm$core$Basics$composeR,
		...
		return A2(
			...
			A2(
				$author$project$GraphApp$minimumMap,
		...
		var toggle_colour = function (p) {
			var ncolour = function () {
				...
				if (_v0.$ === 1) {
					...
					var x = _v0.a;
					return $elm$core$Maybe$Just(1 - x);
				}
			}();
			return _Utils_update(
				p,
...
var $author$project$GraphApp$keymap = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'ArrowLeft',
...
var $author$project$GraphApp$move_point = function (_v0) {
	var dx = _v0.a;
	var dy = _v0.b;
	return $author$project$GraphApp$update_point(
		function (p) {
			return _Utils_update(
				p,
				{
...
var $author$project$GraphApp$move_touches = F2(
	function (model, touchinfos) {
		var get_touch = function (id) {
...
var $author$project$GraphApp$nocmd = function (x) {
...
var $author$project$GraphApp$serialize_edge = function (_v0) {
	var from = _v0.a;
	var to = _v0.b;
	var shape = _v0.c;
...
var $author$project$GraphApp$serialize_path = $elm$json$Json$Encode$list($elm$json$Json$Encode$int);
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$GraphApp$e_nullable = function (e) {
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$Maybe$map(e),
		$elm$core$Maybe$withDefault($elm$json$Json$Encode$null));
};
var $author$project$GraphApp$serialize_vector = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
...
var $author$project$GraphApp$serialize_point = function (p) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$GraphApp$serialize_model = function (model) {
	var success_info = $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'is_hamiltonian',
...
var $author$project$GraphApp$report_state = function (model) {
	return _Utils_Tuple2(
		model,
		A2($elm$core$Basics$composeR, $author$project$GraphApp$serialize_model, $author$project$GraphApp$reportState)(model));
};
...
var $author$project$GraphApp$selected_point = F3(
	function (r, model, pos) {
		var closest = A2(
			$author$project$GraphApp$minimumMap,
			A2(
...
var $author$project$GraphApp$set_scene = F2(
	function (scene, model) {
		return _Utils_update(
			model,
		...
		switch (msg.$) {
			...
			case 0:
				...
				return $author$project$GraphApp$nocmd(
					$author$project$GraphApp$drag_point(
						_Utils_update(
							model,
							{
								f: _Utils_Tuple2(x, y)
...
var $author$project$GraphApp$classList = A2(
...
var $author$project$GraphApp$change_mode_button = function (new_mode) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$GraphApp$ChangeMode(new_mode)),
				$elm$html$Html$Attributes$class('change-mode')
			]),
		_List_fromArray(
			[
...
var $author$project$GraphApp$edit_controls = function (model) {
	var history = _List_fromArray(
		[
			A2(
			$elm$html$Html$button,
			_List_fromArray(
...
var $author$project$GraphApp$preventIfMapped = F3(
	function (mapped_keys, msg, key) {
		var prevent = !_Utils_eq(
			A2($elm$core$Dict$get, key, mapped_keys),
			$elm$core$Maybe$Nothing);
		return _Utils_Tuple2(
			msg(key),
			prevent);
	});
var $author$project$GraphApp$keydown = A2(
	$elm$json$Json$Decode$map,
...
var $author$project$GraphApp$touch_info = F3(
	function (id, x, y) {
		return _Utils_Tuple3(id, x, y);
	});
var $author$project$GraphApp$decode_touch = function (msg) {
	return A2(
		$elm$json$Json$Decode$field,
		'detail',
		A2(
			...
			$elm$json$Json$Decode$list(
				A4(
					$elm$json$Json$Decode$map3,
					$author$project$GraphApp$touch_info,
...
var $author$project$GraphApp$strf = F2(
...
var $author$project$GraphApp$arc = F3(
	function (out, attr, _v0) {
		var _v1 = _v0.a;
		var x1_ = _v1.a;
		var y1_ = _v1.b;
		var _v2 = _v0.b;
		...
		var y2_ = _v2.b;
		var sweep = out ? '1' : '0';
		var r = $author$project$GraphApp$length(
			_Utils_Tuple2(
				_Utils_Tuple2(x1_, y1_),
				_Utils_Tuple2(x2_, y2_)));
		return A2(
			$elm$svg$Svg$path,
			_Utils_ap(
				attr,
				_List_fromArray(
					[
						...
						A2(
							$author$project$GraphApp$strf,
							'M % % A % % 0 0 % % %',
							_List_fromArray(
								[
									$author$project$GraphApp$ff(x1_),
									$author$project$GraphApp$ff(y1_),
									$author$project$GraphApp$ff(r),
									$author$project$GraphApp$ff(r),
									sweep,
									$author$project$GraphApp$ff(x2_),
									$author$project$GraphApp$ff(y2_)
								])))
					])),
			_List_Nil);
	});
...
var $author$project$GraphApp$pline = F2(
	function (attr, _v0) {
		var _v1 = _v0.a;
		var x1_ = _v1.a;
		var y1_ = _v1.b;
...
var $author$project$GraphApp$view_edge = F2(
	function (model, _v0) {
		var segment = _v0.a;
		var edge = _v0.b;
		...
		var one_way_ends_path = F2(
			function (a, b) {
				return _Utils_eq(
					...
					$elm$core$List$head(path)) && _Utils_eq(
					$elm$core$Maybe$Just(b),
		...
		var x2 = _v3.a;
		var y2 = _v3.b;
		var _v4 = _Utils_Tuple2((x1 + x2) / 2, (y1 + y2) / 2);
		var x_ = _v4.a;
		var y_ = _v4.b;
		var _v5 = edge;
		var i = _v5.a;
				...
				return function (_v14) {
					...
					return _Utils_Tuple2(
						...
						v || (_Utils_eq(
							...
							_Utils_Tuple2(
								i,
								$elm$core$Maybe$Just(j))) || _Utils_eq(
							_Utils_Tuple2(a, mb),
							_Utils_Tuple2(
								j,
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2('in-path', in_path || ends_path),
									_Utils_Tuple2('moving-along', moving_along),
									_Utils_Tuple2('can-move-along', can_move_along)
								]))
						]),
					segment)
				]));
...
var $author$project$GraphApp$fi = $elm$core$String$fromInt;
var $author$project$GraphApp$indexOf = F2(
	function (x, l) {
		var indexed = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, l);
		return A3(
			$elm$core$List$foldl,
			function (_v0) {
				var i = _v0.a;
...
var $author$project$GraphApp$tabbable = A2($elm$html$Html$Attributes$attribute, 'tabindex', '0');
				...
				[
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2('selected', selected),
							_Utils_Tuple2('hovered', hovered),
							_Utils_Tuple2('in-path', in_path),
							_Utils_Tuple2(
							'colour-' + $author$project$GraphApp$fi(colour),
							true)
						])),
					$author$project$GraphApp$tabbable,
					A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$GraphApp$ff(0.6)),
							$elm$svg$Svg$Attributes$cx(
							$author$project$GraphApp$ff(x)),
							$elm$svg$Svg$Attributes$cy(
							$author$project$GraphApp$ff(y))
						]),
					_List_Nil),
					A2(
					$elm$svg$Svg$text_,
					_List_fromArray(
						[
							...
							$author$project$GraphApp$ff(y + 1))
						]),
					_List_fromArray(
						[
...
var $author$project$GraphApp$svg_bit = function (model) {
	var edges = $author$project$GraphApp$get_edges(model);
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$viewBox('-10 -10 20 20'),
				A2(
				$elm$svg$Svg$Events$on,
				'svgmove',
				A3(
					$elm$json$Json$Decode$map2,
					$author$project$GraphApp$MouseMove,
					A2(
						$elm$json$Json$Decode$at,
						_List_fromArray(
							['detail', 'x']),
				...
				$elm$svg$Svg$Events$on,
				'svgtouchmove',
				$author$project$GraphApp$decode_touch($author$project$GraphApp$TouchMove)),
				A2(
				$elm$svg$Svg$Events$on,
				'svgtouchend',
				$author$project$GraphApp$decode_touch($author$project$GraphApp$TouchEnd)),
				A2(
				$elm$svg$Svg$Events$on,
				'svgtouchstart',
				$author$project$GraphApp$decode_touch($author$project$GraphApp$TouchStart)),
		...
		_List_fromArray(
			[
				...
				$elm$svg$Svg$g,
				_List_Nil,
				$author$project$GraphApp$view_new_things(model))
			]));
};
var $author$project$GraphApp$theme = 'clp';
var $author$project$GraphApp$view = function (model) {
	var edges = $author$project$GraphApp$get_edges(model);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
